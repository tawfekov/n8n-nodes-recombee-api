...
export class RecombeeSetItemValues implements INodeType {
	description: INodeTypeDescription = {
		usableAsTool: true,
		displayName: 'Recombee SetItemValues',
		name: 'recombeeSetItemValues',
		icon: 'file:../RecombeeNode.svg',
		group: ['transform'],
		version: 1,
		description: 'Sets or updates properties for a specific item. Properties can include product details, categories, prices, and any other item-related information. This operation is essential for maintaining an up-to-date item catalog',
		defaults: {
			name: 'SetItemValues',
		},
